...
function PlanetDetails() {
  ...
  let d = {};
  for (let i in a) {
    console.log(i === planetName["planetName"]);
  ...
  if (paraTitle === "overview") {
    imagePath = d.images.planet;
  } else if (paraTitle === "structure") {
    imagePath = d.images.internal;
  } else if (paraTitle === "geology") {
    imagePath = d.images.geology;
  }

  return (
    <div>
      <div className="  bg-[#13113f]  text-white h-screen ">
       ...
       justify-center flex-col   p-10 "
          >
            ...
            <motion.div
              ...
              exit={{ x: "50%",
              opacity: 0  }}
              className="  w-[calc(30vw-10%)] h-[60%] "
            >
              <h1 className="  text-[50px] uppercase">{d.name}</h1>
              <ParaContent title={paraTitle} d={d} />
              <div className="pt-8 w-[70%] flex-col text-[16px] gap-4 flex">
                <div
                  className="  border-2 p-2 cursor-pointer  "
                  onClick={() => setParaTitle("overview")}
                >
                  <span className=" pr-10 text-gray-400">01</span>
                ...
                >
                  <span className=" pr-10  text-gray-400">02</span>
                  <button className=" uppercase">Internal structure</button>
                </div>
                <div
                  className="  border-2 p-2  cursor-pointer   "
                  onClick={() => setParaTitle("geology")}
                >
                  <span className=" pr-10  text-gray-400">03</span>
